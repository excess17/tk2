...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/nodi/tableWidget/>):
   1. Run `npm i`
...
- **nodi.table.error** (fired when an error occurs)
- **nodi.table.select** (fired when a table row is selected)
